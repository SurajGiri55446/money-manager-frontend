  ...
  return (
    <div className={`card bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-500 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 p-6 pb-4">
        ...
        <button
          className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-xl flex items-center gap-2 transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl shadow-green-200 hover:shadow-green-300"
          onClick={onAddIncome}
        >
      ...
      <div className="p-6 pt-2">
        ...
        {chartData.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg mb-2">No Income Data</p>
            <p className="text-gray-400 text-sm">Add income transactions to see your overview</p>
            <button
              className="mt-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-medium py-2 px-6 rounded-lg flex items-center gap-2 transition-all duration-300 mx-auto transform hover:scale-105"
              onClick={onAddIncome}
            >
              <Plus size={16} />
