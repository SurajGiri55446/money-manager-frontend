...
const TransactionInfoCardE = ({
  ...
  return (
    <div className="group relative flex items-center justify-between gap-3 p-4 rounded-xl bg-white border border-gray-100 hover:border-purple-200 hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]">
      {/* Icon */}
      <div className="w-12 h-12 flex items-center justify-center text-xl bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl shadow-sm group-hover:shadow transition-all duration-300">
        {icon ? (
...
export default TransactionInfoCardE;