...
import { Download, Mail, TrendingUp, FileText, Send } from "lucide-react";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {transactions?.length || 0} income source{transactions?.length !== 1 ? 's' : ''}
            </p>
          </div>
        </div>
      ...
      <div className="p-6 pt-2">
        {(!transactions || transactions.length === 0) ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg mb-2">No Income Sources</p>
            <p className="text-gray-400 text-sm">Income transactions will appear here</p>
          </div>
        ) : (
